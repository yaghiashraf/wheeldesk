...
const COLUMNS: Array<[string, (row: ResearchRow) => string | number]> = [
  ...
  ["bid_premium_per_contract", (r) => (r.bid === null ? "" : r.bid * 100)],
  ["roi_on_strike", (r) => r.roc],
  ["delta", (r) => r.delta ?? ""],
  ["iv", (r) => r.iv ?? ""],
  ["iv_rv", (r) => r.ivRv ?? ""],
  ["rv_30", (r) => r.rv30 ?? ""],
  ["rv_30_source", (r) => r.rv30Source ?? ""],
  ["price_history_source", (r) => r.priceHistorySource ?? ""],
  ["price_history_observations", (r) => r.priceHistoryObservations],
  ["high_52w", (r) => r.high52w ?? ""],
  ["drawdown_52w", (r) => r.drawdown52w ?? ""],
  ["return_1m", (r) => r.return1m ?? ""],
  ["return_3m", (r) => r.return3m ?? ""],
  ["iv_30", (r) => r.iv30 ?? ""],
  ...
  ["opportunity_tier", (r) => r.research.opportunityTier],
  ["opportunity_score", (r) => r.research.opportunityScore],
  ["opportunity_reasons", (r) => r.research.opportunityReasons.join(" | ")],
